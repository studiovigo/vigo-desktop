...
-- NOMES CORRIGIDOS CONFORME TABELAS EXISTENTES
-- =====================================================
...
-- =====================================================
-- TABELA: users (USUÁRIOS) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: products (PRODUTOS) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: cash_sessions (SESSÕES DE CAIXA) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: sale_items (ITENS DE VENDA) ✓ JÁ EXISTE
-- =====================================================
-- Armazena itens individuais de cada venda (tabela separada)
...
-- =====================================================
-- TABELA: coupons (CUPONS DE DESCONTO) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: expenses (DESPESAS) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: cash_closures (FECHAMENTOS DE CAIXA) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: pending_signups (CADASTROS PENDENTES) ✓ JÁ EXISTE
-- =====================================================
-- Armazena cadastros pendentes de aprovação/pagamento
-- NOME CORRETO: pending_signups (não pending_registrations)
...
-- =====================================================
-- TABELA: pos_stations (ESTAÇÕES DE PDV) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: terminals (TERMINAIS) ✓ JÁ EXISTE
-- =====================================================
-- Armazena informações dos terminais (pode ser similar a pos_stations)
...
-- =====================================================
-- TABELA: warehouse_stock (ESTOQUE DE DEPÓSITO) ✓ JÁ EXISTE
-- =====================================================
...
-- =====================================================
-- TABELA: closures (FECHAMENTOS - DEPRECATED) ✓ JÁ EXISTE
-- =====================================================
-- NOTA: Esta tabela parece ser uma duplicação de cash_closures
-- Recomenda-se usar apenas cash_closures e migrar dados se necessário
-- Mantida aqui por compatibilidade
...
-- 
-- TABELAS CRIADAS/VERIFICADAS (19 TABELAS):
-- ✓ stores (lojas)
-- ✓ users (usuários)
-- ✓ products (produtos)
-- ✓ cash_sessions (sessões de caixa)
-- ✓ sales (vendas)
-- ✓ sale_items (itens de venda) - TABELA SEPARADA
...
-- ✓ pending_signups (cadastros pendentes) - NOME CORRETO
-- ✓ settings (configurações)
-- ✓ pos_stations (estações de PDV)
-- ✓ terminals (terminais)
-- ✓ warehouse_stock (estoque de depósito)
-- ✓ closures (fechamentos - DEPRECATED, usar cash_closures)
-- 
-- FUNÇÕES RPC:
-- ✓ create_sale_atomic (criar venda atômica com validação de estoque)
-- 
-- CORREÇÕES APLICADAS:
-- - pending_registrations → pending_signups
-- - Adicionada tabela sale_items (itens separados)
-- - Adicionadas tabelas pos_stations, terminals, warehouse_stock
-- - Mantida tabela closures por compatibilidade (usar cash_closures)
-- =====================================================
