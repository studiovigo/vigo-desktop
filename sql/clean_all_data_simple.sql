-- =====================================================
-- LIMPAR DADOS DE TODAS AS TABELAS (VERSÃO SIMPLES)
-- =====================================================
-- Delete simples respeitando a ordem de foreign keys
-- =====================================================

-- PASSO 1: Deletar dados nas tabelas dependentes primeiro
DELETE FROM sales;
...
-- PASSO 2: Resetar sequências de IDs para começar do 1
ALTER SEQUENCE IF EXISTS stores_id_seq RESTART WITH 1;
ALTER SEQUENCE IF EXISTS users_id_seq RESTART WITH 1;
ALTER SEQUENCE IF EXISTS products_id_seq RESTART WITH 1;

-- PASSO 3: Verificar se limpou (contar registros)
SELECT 
